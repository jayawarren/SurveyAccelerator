...
/****** Object:  Table [dd].[factNewMemBranchSurveyResponders]    Script Date: 08/03/2013 20:12:59 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dd].[factNewMemBranchSurveyResponders]
(
	[NewMemBranchSurveyRespondersKey] [int] IDENTITY(1, 1) NOT NULL PRIMARY KEY,
