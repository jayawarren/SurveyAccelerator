...
/****** Object:  Table [dd].[factNewMemBranchExperienceReport]    Script Date: 08/04/2013 07:14:48 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dd].[factNewMemBranchExperienceReport](
	[NewMemBranchExperienceReportKey] [int] IDENTITY(1, 1) NOT NULL PRIMARY KEY,
