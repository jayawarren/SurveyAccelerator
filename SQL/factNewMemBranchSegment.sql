...
/****** Object:  Table [dd].[factNewMemBranchSegment]    Script Date: 08/04/2013 07:14:48 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dd].[factNewMemBranchSegment](
	[NewMemBranchSegmentKey] [int] IDENTITY(1, 1) NOT NULL PRIMARY KEY,
