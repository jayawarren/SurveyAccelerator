...
/****** Object:  Table [dd].[factEmpSatDashboardBase]    Script Date: 08/02/2013 07:22:51 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dd].[factEmpSatDashboardBase](
	[EmpSatDashboardBaseKey] [int] IDENTITY NOT NULL PRIMARY KEY,
