/*
truncate table Seer_ODS.dbo.Survey_Results
drop procedure spPopulate_odsSurvey_Results
select * from Seer_ODS.dbo.SurveyResults
*/
CREATE PROCEDURE spPopulate_odsSurvey_Results AS
BEGIN
...
BEGIN TRAN
	MERGE	Seer_ODS.dbo.Survey_Results AS target
	USING	(
			SELECT	E.module,
					E.batch_number,
	...
	USING	(
			...
			WHERE	((ISNUMERIC(A.[response_count]) = 1) OR (LEN(COALESCE(A.[response_count], '')) = 0))
					...
					*/
					...
					AND ((ISNUMERIC(A.[Achievement Z-Score]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Achievement Z-Score]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Achievement Z-Score], '')) = 0))
					AND ((ISNUMERIC(A.[Belonging Z-Score]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Belonging Z-Score]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Belonging Z-Score], '')) = 0))
					AND ((ISNUMERIC(A.[Character Z-Score]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Character Z-Score]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Character Z-Score], '')) = 0))
					AND ((ISNUMERIC(A.[Giving Z-Score]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Giving Z-Score]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Giving Z-Score], '')) = 0))
					AND ((ISNUMERIC(A.[Health Z-Score]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Health Z-Score]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Health Z-Score], '')) = 0))
					AND ((ISNUMERIC(A.[Inspiration Z-Score]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Inspiration Z-Score]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Inspiration Z-Score], '')) = 0))
					AND ((ISNUMERIC(A.[Meaning Z-Score]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Meaning Z-Score]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Meaning Z-Score], '')) = 0))
					AND ((ISNUMERIC(A.[Relationship Z-Score]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Relationship Z-Score]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Relationship Z-Score], '')) = 0))
					AND ((ISNUMERIC(A.[Safety Z-Score]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Safety Z-Score]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Safety Z-Score], '')) = 0))
...
BEGIN TRAN
	...
	WHERE	LEN(A.Form_Code) = 0
			...
			*/
			...
			OR ((ISNUMERIC(A.[Achievement Z-Score]) = 0 AND LEN(A.[Achievement Z-Score]) > 0) OR (ISNUMERIC(COALESCE(A.[Achievement Z-Score], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Achievement Z-Score]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Belonging Z-Score]) = 0 AND LEN(A.[Belonging Z-Score]) > 0) OR (ISNUMERIC(COALESCE(A.[Belonging Z-Score], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Belonging Z-Score]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Character Z-Score]) = 0 AND LEN(A.[Character Z-Score]) > 0) OR (ISNUMERIC(COALESCE(A.[Character Z-Score], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Character Z-Score]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Giving Z-Score]) = 0 AND LEN(A.[Giving Z-Score]) > 0) OR (ISNUMERIC(COALESCE(A.[Giving Z-Score], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Giving Z-Score]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Health Z-Score]) = 0 AND LEN(A.[Health Z-Score]) > 0) OR (ISNUMERIC(COALESCE(A.[Health Z-Score], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Health Z-Score]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Inspiration Z-Score]) = 0 AND LEN(A.[Inspiration Z-Score]) > 0) OR (ISNUMERIC(COALESCE(A.[Inspiration Z-Score], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Inspiration Z-Score]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Meaning Z-Score]) = 0 AND LEN(A.[Meaning Z-Score]) > 0) OR (ISNUMERIC(COALESCE(A.[Meaning Z-Score], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Meaning Z-Score]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Relationship Z-Score]) = 0 AND LEN(A.[Relationship Z-Score]) > 0) OR (ISNUMERIC(COALESCE(A.[Relationship Z-Score], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Relationship Z-Score]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Safety Z-Score]) = 0 AND LEN(A.[Safety Z-Score]) > 0) OR (ISNUMERIC(COALESCE(A.[Safety Z-Score], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Safety Z-Score]) NOT BETWEEN 0.000000 AND 1.000000))
