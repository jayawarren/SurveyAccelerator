...
/****** Object:  Table [dd].[factEmpSatBranchSurveyResponders]    Script Date: 08/03/2013 20:12:59 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dd].[factEmpSatBranchSurveyResponders]
(
	[EmpSatBranchSurveyRespondersKey] [int] IDENTITY(1, 1) NOT NULL PRIMARY KEY,
