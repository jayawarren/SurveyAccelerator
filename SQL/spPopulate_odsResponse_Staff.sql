CREATE PROCEDURE spPopulate_odsResponse_Staff AS
BEGIN
	...
	USING	(
			SELECT	'Staff' module,
					...
					A.[Right_FileName] right_file_name

			FROM	Seer_STG.dbo.[Staff Response Data] A
	...
	;
	INSERT INTO Seer_CTRL.dbo.[Staff Response Data]([Member_Key],
														[SEERKEY],
														[CFID],
														[MFID],
														[ASSOCIATION_NAME],
	...
	SELECT	COALESCE(B.[member_key], C.[member_key]),
			A.[SEERKEY],
			A.[CFID],
			A.[MFID],
			A.[ASSOCIATION_NAME],
