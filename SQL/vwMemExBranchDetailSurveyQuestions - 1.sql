...
--SELECT * FROM [dd].[vwMemExBranchDetailSurveyQuestions] WHERE associationname = 'YMCA of San Francisco' and Question like 'overall, how would you rate%' order by 2,3,4
...
--select * from rpt_allr WHERE associationname = 'YMCA of San Francisco' and Question like 'overall, how would you rate%'
,rpt_miss AS (
SELECT	distinct
		db.AssociationKey,
		db.BranchKey,
...
--select * from rpt_miss WHERE associationname = 'YMCA of San Francisco' and Question like 'overall, how would you rate%'
,rpt AS (
SELECT	distinct
...
--select * from rpt WHERE associationname = 'YMCA of San Francisco' and Question like 'overall, how would you rate%'
,rptrolled AS (
