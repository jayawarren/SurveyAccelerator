			...
			FROM	(
					...
					FROM	Seer_MDM.dbo.Member_Map A
							...
							INNER JOIN Seer_MDM.dbo.Organization G
								ON A.organization_key = G.organization_key
							INNER JOIN Seer_ODS.dbo.Observation_Data D
								ON A.member_key = D.member_key
									AND G.association_number = D.official_association_number
									AND G.official_branch_number = D.official_branch_number
					...
					WHERE	E.product_category LIKE '%Program Survey%'
					...
					FROM	Seer_MDM.dbo.Member_Map A
							...
							INNER JOIN Seer_MDM.dbo.Organization G
								ON A.organization_key = G.organization_key
							INNER JOIN Seer_ODS.dbo.Close_Ends D
								ON A.member_key = D.member_key
									AND G.association_number = D.official_association_number
									AND G.official_branch_number = D.official_branch_number
							INNER JOIN Seer_MDM.dbo.Survey_Form E
