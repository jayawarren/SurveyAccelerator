...
/****** Object:  Table [dbo].[factAssociationNewMemberExperienceReport]    Script Date: 07/31/2013 12:43:28 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[factAssociationNewMemberExperienceReport](
	[AssociationNewMemberExperienceReportKey] [int] IDENTITY(1, 1) NOT NULL PRIMARY KEY,
	...
	[PreviousAssociationPercentage] [decimal](15, 5) DEFAULT 0,
