...
/****** Object:  Table [dd].[factNewMemAssociationSegment]    Script Date: 08/04/2013 07:14:48 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dd].[factNewMemAssociationSegment](
	[NewMemAssociationSegmentKey] [int] IDENTITY(1, 1) NOT NULL PRIMARY KEY,
	...
	[PreviousPercentage] [decimal](15, 5) DEFAULT 0,
