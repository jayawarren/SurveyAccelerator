...
/****** Object:  Table [dbo].[factBranchMemberSatisfactionReport]    Script Date: 07/29/2013 06:45:06 ******/
SET ANSI_NULLS ON
GO
...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[factBranchMemberSatisfactionReport](
	[BranchMemberSatisfactionReportKey] [bigint] IDENTITY(1, 1) NOT NULL PRIMARY KEY,
	[BranchKey] [int] NULL DEFAULT 0,
	...
	[BranchCount] [int] NULL DEFAULT 0,
	[BranchPercentage] [decimal](15, 5) NULL DEFAULT 0,
	...
	[PreviousBranchPercentage] [decimal](15, 5) NULL DEFAULT 0,
