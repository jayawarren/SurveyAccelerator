...
/****** Object:  View [dd].[vwMemEx2012SurveyAssociations]    Script Date: 08/01/2013 16:08:32 ******/
SET ANSI_NULLS ON
GO
...
ALTER VIEW [dd].[vwMemEx2012SurveyAssociations]
AS 
...
WHERE	C.SurveyType = 'YMCA Membership Satisfaction Survey'
		AND A.module = 'Member'
