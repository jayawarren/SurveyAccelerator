...
/****** Object:  Table [dd].[factMemExAssociationSurveyResponders]    Script Date: 08/03/2013 20:12:59 ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dd].[factMemExAssociationSurveyResponders]
(
	[MemExAssociationSurveyRespondersKey] [int] IDENTITY(1, 1) NOT NULL PRIMARY KEY,
