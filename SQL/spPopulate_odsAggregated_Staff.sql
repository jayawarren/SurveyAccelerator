...
truncate table Seer_CTRL.dbo.[Staff Aggregated Data]
drop procedure spPopulate_odsAggregated_Staff
select * from Seer_ODS.dbo.Aggregated_Data
select * from Seer_CTRL.dbo.[Staff Aggregated Data]
*/
CREATE PROCEDURE spPopulate_odsAggregated_Staff AS
BEGIN
...
BEGIN TRAN
	...
	USING	(
			SELECT	1 current_indicator,
					...
					CASE WHEN LEN(COALESCE(A.[Avg_Q_60_11], '')) = 0 THEN '0' ELSE A.[Avg_Q_60_11] END [avg_q_60_11],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_60_12], '')) = 0 THEN '0' ELSE A.[Avg_Q_60_12] END [avg_q_60_12],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_60_13], '')) = 0 THEN '0' ELSE A.[Avg_Q_60_13] END [avg_q_60_13],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_60_14], '')) = 0 THEN '0' ELSE A.[Avg_Q_60_14] END [avg_q_60_14],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_60_15], '')) = 0 THEN '0' ELSE A.[Avg_Q_60_15] END [avg_q_60_15],
					...
					CASE WHEN LEN(COALESCE(A.[Avg_Q_61_11], '')) = 0 THEN '0' ELSE A.[Avg_Q_61_11] END [avg_q_61_11],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_61_12], '')) = 0 THEN '0' ELSE A.[Avg_Q_61_12] END [avg_q_61_12],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_61_13], '')) = 0 THEN '0' ELSE A.[Avg_Q_61_13] END [avg_q_61_13],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_61_14], '')) = 0 THEN '0' ELSE A.[Avg_Q_61_14] END [avg_q_61_14],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_61_15], '')) = 0 THEN '0' ELSE A.[Avg_Q_61_15] END [avg_q_61_15],
					...
					CASE WHEN LEN(COALESCE(A.[Avg_Q_62_11], '')) = 0 THEN '0' ELSE A.[Avg_Q_62_11] END [avg_q_62_11],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_62_12], '')) = 0 THEN '0' ELSE A.[Avg_Q_62_12] END [avg_q_62_12],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_62_13], '')) = 0 THEN '0' ELSE A.[Avg_Q_62_13] END [avg_q_62_13],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_62_14], '')) = 0 THEN '0' ELSE A.[Avg_Q_62_14] END [avg_q_62_14],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_62_15], '')) = 0 THEN '0' ELSE A.[Avg_Q_62_15] END [avg_q_62_15],
					...
					CASE WHEN LEN(COALESCE(A.[Avg_Q_63_11], '')) = 0 THEN '0' ELSE A.[Avg_Q_63_11] END [avg_q_63_11],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_63_12], '')) = 0 THEN '0' ELSE A.[Avg_Q_63_12] END [avg_q_63_12],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_63_13], '')) = 0 THEN '0' ELSE A.[Avg_Q_63_13] END [avg_q_63_13],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_63_14], '')) = 0 THEN '0' ELSE A.[Avg_Q_63_14] END [avg_q_63_14],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_63_15], '')) = 0 THEN '0' ELSE A.[Avg_Q_63_15] END [avg_q_63_15],
					...
					CASE WHEN LEN(COALESCE(A.[Avg_Q_64_11], '')) = 0 THEN '0' ELSE A.[Avg_Q_64_11] END [avg_q_64_11],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_64_12], '')) = 0 THEN '0' ELSE A.[Avg_Q_64_12] END [avg_q_64_12],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_64_13], '')) = 0 THEN '0' ELSE A.[Avg_Q_64_13] END [avg_q_64_13],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_64_14], '')) = 0 THEN '0' ELSE A.[Avg_Q_64_14] END [avg_q_64_14],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_64_15], '')) = 0 THEN '0' ELSE A.[Avg_Q_64_15] END [avg_q_64_15],
					...
					CASE WHEN LEN(COALESCE(A.[Avg_Q_65_11], '')) = 0 THEN '0' ELSE A.[Avg_Q_65_11] END [avg_q_65_11],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_65_12], '')) = 0 THEN '0' ELSE A.[Avg_Q_65_12] END [avg_q_65_12],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_65_13], '')) = 0 THEN '0' ELSE A.[Avg_Q_65_13] END [avg_q_65_13],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_65_14], '')) = 0 THEN '0' ELSE A.[Avg_Q_65_14] END [avg_q_65_14],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_65_15], '')) = 0 THEN '0' ELSE A.[Avg_Q_65_15] END [avg_q_65_15],
					...
					CASE WHEN LEN(COALESCE(A.[Avg_Q_66_11], '')) = 0 THEN '0' ELSE A.[Avg_Q_66_11] END [avg_q_66_11],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_66_12], '')) = 0 THEN '0' ELSE A.[Avg_Q_66_12] END [avg_q_66_12],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_66_13], '')) = 0 THEN '0' ELSE A.[Avg_Q_66_13] END [avg_q_66_13],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_66_14], '')) = 0 THEN '0' ELSE A.[Avg_Q_66_14] END [avg_q_66_14],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_66_15], '')) = 0 THEN '0' ELSE A.[Avg_Q_66_15] END [avg_q_66_15],
					...
					CASE WHEN LEN(COALESCE(A.[Avg_Q_67_11], '')) = 0 THEN '0' ELSE A.[Avg_Q_67_11] END [avg_q_67_11],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_67_12], '')) = 0 THEN '0' ELSE A.[Avg_Q_67_12] END [avg_q_67_12],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_67_13], '')) = 0 THEN '0' ELSE A.[Avg_Q_67_13] END [avg_q_67_13],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_67_14], '')) = 0 THEN '0' ELSE A.[Avg_Q_67_14] END [avg_q_67_14],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_67_15], '')) = 0 THEN '0' ELSE A.[Avg_Q_67_15] END [avg_q_67_15],
					...
					CASE WHEN LEN(COALESCE(A.[Avg_Q_68_11], '')) = 0 THEN '0' ELSE A.[Avg_Q_68_11] END [avg_q_68_11],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_68_12], '')) = 0 THEN '0' ELSE A.[Avg_Q_68_12] END [avg_q_68_12],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_68_13], '')) = 0 THEN '0' ELSE A.[Avg_Q_68_13] END [avg_q_68_13],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_68_14], '')) = 0 THEN '0' ELSE A.[Avg_Q_68_14] END [avg_q_68_14],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_68_15], '')) = 0 THEN '0' ELSE A.[Avg_Q_68_15] END [avg_q_68_15],
					...
					CASE WHEN LEN(COALESCE(A.[Avg_Q_69_11], '')) = 0 THEN '0' ELSE A.[Avg_Q_69_11] END [avg_q_69_11],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_69_12], '')) = 0 THEN '0' ELSE A.[Avg_Q_69_12] END [avg_q_69_12],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_69_13], '')) = 0 THEN '0' ELSE A.[Avg_Q_69_13] END [avg_q_69_13],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_69_14], '')) = 0 THEN '0' ELSE A.[Avg_Q_69_14] END [avg_q_69_14],
					CASE WHEN LEN(COALESCE(A.[Avg_Q_69_15], '')) = 0 THEN '0' ELSE A.[Avg_Q_69_15] END [avg_q_69_15],
					...
					*/
					CASE WHEN LEN(COALESCE(A.[NPS_MEM], '')) = 0 THEN '0' ELSE A.[NPS_MEM] END [nps_mem],
					CASE WHEN LEN(COALESCE(A.[NPS_WORK], '')) = 0 THEN '0' ELSE A.[NPS_WORK] END [nps_work],
			...
			FROM	Seer_STG.dbo.[Staff Aggregated Data] A
			...
			WHERE	((ISNUMERIC(A.[response_count]) = 1) OR (LEN(COALESCE(A.[response_count], '')) = 0))
					...
					AND ((ISNUMERIC(A.[Avg_Q_60_11]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_60_11]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_60_11], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_60_12]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_60_12]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_60_12], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_60_13]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_60_13]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_60_13], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_60_14]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_60_14]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_60_14], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_60_15]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_60_15]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_60_15], '')) = 0))
					...
					AND ((ISNUMERIC(A.[Avg_Q_61_11]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_61_11]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_61_11], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_61_12]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_61_12]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_61_12], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_61_13]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_61_13]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_61_13], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_61_14]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_61_14]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_61_14], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_61_15]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_61_15]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_61_15], '')) = 0))
					...
					AND ((ISNUMERIC(A.[Avg_Q_62_11]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_62_11]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_62_11], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_62_12]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_62_12]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_62_12], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_62_13]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_62_13]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_62_13], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_62_14]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_62_14]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_62_14], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_62_15]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_62_15]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_62_15], '')) = 0))
					...
					AND ((ISNUMERIC(A.[Avg_Q_63_11]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_63_11]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_63_11], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_63_12]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_63_12]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_63_12], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_63_13]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_63_13]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_63_13], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_63_14]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_63_14]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_63_14], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_63_15]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_63_15]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_63_15], '')) = 0))
					...
					AND ((ISNUMERIC(A.[Avg_Q_64_11]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_64_11]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_64_11], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_64_12]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_64_12]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_64_12], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_64_13]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_64_13]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_64_13], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_64_14]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_64_14]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_64_14], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_64_15]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_64_15]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_64_15], '')) = 0))
					...
					AND ((ISNUMERIC(A.[Avg_Q_65_11]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_65_11]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_65_11], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_65_12]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_65_12]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_65_12], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_65_13]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_65_13]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_65_13], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_65_14]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_65_14]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_65_14], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_65_15]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_65_15]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_65_15], '')) = 0))
					...
					AND ((ISNUMERIC(A.[Avg_Q_66_11]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_66_11]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_66_11], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_66_12]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_66_12]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_66_12], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_66_13]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_66_13]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_66_13], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_66_14]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_66_14]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_66_14], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_66_15]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_66_15]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_66_15], '')) = 0))
					...
					AND ((ISNUMERIC(A.[Avg_Q_67_11]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_67_11]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_67_11], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_67_12]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_67_12]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_67_12], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_67_13]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_67_13]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_67_13], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_67_14]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_67_14]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_67_14], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_67_15]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_67_15]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_67_15], '')) = 0))
					...
					AND ((ISNUMERIC(A.[Avg_Q_68_11]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_68_11]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_68_11], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_68_12]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_68_12]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_68_12], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_68_13]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_68_13]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_68_13], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_68_14]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_68_14]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_68_14], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_68_15]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_68_15]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_68_15], '')) = 0))
					...
					AND ((ISNUMERIC(A.[Avg_Q_69_11]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_69_11]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_69_11], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_69_12]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_69_12]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_69_12], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_69_13]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_69_13]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_69_13], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_69_14]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_69_14]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_69_14], '')) = 0))
					AND ((ISNUMERIC(A.[Avg_Q_69_15]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_69_15]) BETWEEN 0.000000 AND 1.000000) OR (LEN(COALESCE(A.[Avg_Q_69_15], '')) = 0))
					...
					*/
					AND ((ISNUMERIC(A.[NPS_MEM]) = 1 AND CONVERT(DECIMAL(20, 6), A.[NPS_MEM]) BETWEEN -1.000000 AND 1.000000) OR (LEN(COALESCE(A.[NPS_MEM], '')) = 0))
					AND ((ISNUMERIC(A.[NPS_WORK]) = 1 AND CONVERT(DECIMAL(20, 6), A.[NPS_WORK]) BETWEEN -1.000000 AND 1.000000) OR (LEN(COALESCE(A.[NPS_WORK], '')) = 0))
					...
					AND ((ISNUMERIC(A.[Achievement Z-Score]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Achievement z-score]) BETWEEN -10.000000 AND 10.000000) OR (LEN(COALESCE(A.[Achievement Z-Score], '')) = 0))
					AND ((ISNUMERIC(A.[Belonging Z-Score]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Belonging z-score]) BETWEEN -10.000000 AND 10.000000) OR (LEN(COALESCE(A.[Belonging Z-Score], '')) = 0))
					AND ((ISNUMERIC(A.[Character Z-Score]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Character z-score]) BETWEEN -10.000000 AND 10.000000) OR (LEN(COALESCE(A.[Character Z-Score], '')) = 0))
					AND ((ISNUMERIC(A.[Giving Z-Score]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Giving z-score]) BETWEEN -10.000000 AND 10.000000) OR (LEN(COALESCE(A.[Giving Z-Score], '')) = 0))
					AND ((ISNUMERIC(A.[Health Z-Score]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Health z-score]) BETWEEN -10.000000 AND 10.000000) OR (LEN(COALESCE(A.[Health Z-Score], '')) = 0))
					AND ((ISNUMERIC(A.[Inspiration Z-Score]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Inspiration z-score]) BETWEEN -10.000000 AND 10.000000) OR (LEN(COALESCE(A.[Inspiration Z-Score], '')) = 0))
					AND ((ISNUMERIC(A.[Meaning Z-Score]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Meaning z-score]) BETWEEN -10.000000 AND 10.000000) OR (LEN(COALESCE(A.[Meaning Z-Score], '')) = 0))
					AND ((ISNUMERIC(A.[Relationship Z-Score]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Relationship z-score]) BETWEEN -10.000000 AND 10.000000) OR (LEN(COALESCE(A.[Relationship Z-Score], '')) = 0))
					AND ((ISNUMERIC(A.[Safety Z-Score]) = 1 AND CONVERT(DECIMAL(20, 6), A.[Safety z-score]) BETWEEN -10.000000 AND 10.000000) OR (LEN(COALESCE(A.[Safety Z-Score], '')) = 0))
			...
			WHEN MATCHED AND (target.[response_load_date] <> source.[response_load_date]
								...
								OR target.[avg_q_60_11] <> source.[avg_q_60_11]
								OR target.[avg_q_60_12] <> source.[avg_q_60_12]
								OR target.[avg_q_60_13] <> source.[avg_q_60_13]
								OR target.[avg_q_60_14] <> source.[avg_q_60_14]
								OR target.[avg_q_60_15] <> source.[avg_q_60_15]
								...
								OR target.[avg_q_61_11] <> source.[avg_q_61_11]
								OR target.[avg_q_61_12] <> source.[avg_q_61_12]
								OR target.[avg_q_61_13] <> source.[avg_q_61_13]
								OR target.[avg_q_61_14] <> source.[avg_q_61_14]
								OR target.[avg_q_61_15] <> source.[avg_q_61_15]
								...
								OR target.[avg_q_62_11] <> source.[avg_q_62_11]
								OR target.[avg_q_62_12] <> source.[avg_q_62_12]
								OR target.[avg_q_62_13] <> source.[avg_q_62_13]
								OR target.[avg_q_62_14] <> source.[avg_q_62_14]
								OR target.[avg_q_62_15] <> source.[avg_q_62_15]
								...
								OR target.[avg_q_63_11] <> source.[avg_q_63_11]
								OR target.[avg_q_63_12] <> source.[avg_q_63_12]
								OR target.[avg_q_63_13] <> source.[avg_q_63_13]
								OR target.[avg_q_63_14] <> source.[avg_q_63_14]
								OR target.[avg_q_63_15] <> source.[avg_q_63_15]
								OR target.[avg_q_64_00] <> source.[avg_q_64_00]
								...
								OR target.[avg_q_64_11] <> source.[avg_q_64_11]
								OR target.[avg_q_64_12] <> source.[avg_q_64_12]
								OR target.[avg_q_64_13] <> source.[avg_q_64_13]
								OR target.[avg_q_64_14] <> source.[avg_q_64_14]
								OR target.[avg_q_64_15] <> source.[avg_q_64_15]
								...
								OR target.[avg_q_65_11] <> source.[avg_q_65_11]
								OR target.[avg_q_65_12] <> source.[avg_q_65_12]
								OR target.[avg_q_65_13] <> source.[avg_q_65_13]
								OR target.[avg_q_65_14] <> source.[avg_q_65_14]
								OR target.[avg_q_65_15] <> source.[avg_q_65_15]
								...
								OR target.[avg_q_66_11] <> source.[avg_q_66_11]
								OR target.[avg_q_66_12] <> source.[avg_q_66_12]
								OR target.[avg_q_66_13] <> source.[avg_q_66_13]
								OR target.[avg_q_66_14] <> source.[avg_q_66_14]
								OR target.[avg_q_66_15] <> source.[avg_q_66_15]
								...
								OR target.[avg_q_67_11] <> source.[avg_q_67_11]
								OR target.[avg_q_67_12] <> source.[avg_q_67_12]
								OR target.[avg_q_67_13] <> source.[avg_q_67_13]
								OR target.[avg_q_67_14] <> source.[avg_q_67_14]
								OR target.[avg_q_67_15] <> source.[avg_q_67_15]
								...
								OR target.[avg_q_68_11] <> source.[avg_q_68_11]
								OR target.[avg_q_68_12] <> source.[avg_q_68_12]
								OR target.[avg_q_68_13] <> source.[avg_q_68_13]
								OR target.[avg_q_68_14] <> source.[avg_q_68_14]
								OR target.[avg_q_68_15] <> source.[avg_q_68_15]
								...
								OR target.[avg_q_69_11] <> source.[avg_q_69_11]
								OR target.[avg_q_69_12] <> source.[avg_q_69_12]
								OR target.[avg_q_69_13] <> source.[avg_q_69_13]
								OR target.[avg_q_69_14] <> source.[avg_q_69_14]
								OR target.[avg_q_69_15] <> source.[avg_q_69_15]
								...
								*/
								OR target.[nps_mem] <> source.[nps_mem]
								OR target.[nps_work] <> source.[nps_work]
...
BEGIN TRAN
	INSERT INTO Seer_CTRL.dbo.[Staff Aggregated Data]([Aggregate_Type],
														[Response_Load_Date],
														[Form_Code],
														[Association_Name],
														[Off_Assoc_Num],
	...
	WHERE	LEN(A.Form_Code) = 0
			...
			OR ((ISNUMERIC(A.[Avg_Q_60_11]) = 0 AND LEN(A.[Avg_Q_60_11]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_60_11], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_60_11]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_60_12]) = 0 AND LEN(A.[Avg_Q_60_12]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_60_12], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_60_12]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_60_13]) = 0 AND LEN(A.[Avg_Q_60_13]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_60_13], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_60_13]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_60_14]) = 0 AND LEN(A.[Avg_Q_60_14]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_60_14], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_60_14]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_60_15]) = 0 AND LEN(A.[Avg_Q_60_15]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_60_15], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_60_15]) NOT BETWEEN 0.000000 AND 1.000000))
			...
			OR ((ISNUMERIC(A.[Avg_Q_61_11]) = 0 AND LEN(A.[Avg_Q_61_11]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_61_11], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_61_11]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_61_12]) = 0 AND LEN(A.[Avg_Q_61_12]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_61_12], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_61_12]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_61_13]) = 0 AND LEN(A.[Avg_Q_61_13]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_61_13], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_61_13]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_61_14]) = 0 AND LEN(A.[Avg_Q_61_14]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_61_14], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_61_14]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_61_15]) = 0 AND LEN(A.[Avg_Q_61_15]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_61_15], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_61_15]) NOT BETWEEN 0.000000 AND 1.000000))
			...
			OR ((ISNUMERIC(A.[Avg_Q_62_11]) = 0 AND LEN(A.[Avg_Q_62_11]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_62_11], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_62_11]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_62_12]) = 0 AND LEN(A.[Avg_Q_62_12]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_62_12], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_62_12]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_62_13]) = 0 AND LEN(A.[Avg_Q_62_13]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_62_13], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_62_13]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_62_14]) = 0 AND LEN(A.[Avg_Q_62_14]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_62_14], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_62_14]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_62_15]) = 0 AND LEN(A.[Avg_Q_62_15]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_62_15], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_62_15]) NOT BETWEEN 0.000000 AND 1.000000))
			...
			OR ((ISNUMERIC(A.[Avg_Q_63_11]) = 0 AND LEN(A.[Avg_Q_63_11]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_63_11], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_63_11]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_63_12]) = 0 AND LEN(A.[Avg_Q_63_12]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_63_12], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_63_12]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_63_13]) = 0 AND LEN(A.[Avg_Q_63_13]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_63_13], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_63_13]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_63_14]) = 0 AND LEN(A.[Avg_Q_63_14]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_63_14], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_63_14]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_63_15]) = 0 AND LEN(A.[Avg_Q_63_15]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_63_15], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_63_15]) NOT BETWEEN 0.000000 AND 1.000000))
			...
			OR ((ISNUMERIC(A.[Avg_Q_64_11]) = 0 AND LEN(A.[Avg_Q_64_11]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_64_11], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_64_11]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_64_12]) = 0 AND LEN(A.[Avg_Q_64_12]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_64_12], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_64_12]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_64_13]) = 0 AND LEN(A.[Avg_Q_64_13]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_64_13], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_64_13]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_64_14]) = 0 AND LEN(A.[Avg_Q_64_14]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_64_14], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_64_14]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_64_15]) = 0 AND LEN(A.[Avg_Q_64_15]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_64_15], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_64_15]) NOT BETWEEN 0.000000 AND 1.000000))
			...
			OR ((ISNUMERIC(A.[Avg_Q_65_11]) = 0 AND LEN(A.[Avg_Q_65_11]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_65_11], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_65_11]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_65_12]) = 0 AND LEN(A.[Avg_Q_65_12]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_65_12], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_65_12]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_65_13]) = 0 AND LEN(A.[Avg_Q_65_13]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_65_13], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_65_13]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_65_14]) = 0 AND LEN(A.[Avg_Q_65_14]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_65_14], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_65_14]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_65_15]) = 0 AND LEN(A.[Avg_Q_65_15]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_65_15], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_65_15]) NOT BETWEEN 0.000000 AND 1.000000))
			...
			OR ((ISNUMERIC(A.[Avg_Q_66_11]) = 0 AND LEN(A.[Avg_Q_66_11]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_66_11], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_66_11]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_66_12]) = 0 AND LEN(A.[Avg_Q_66_12]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_66_12], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_66_12]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_66_13]) = 0 AND LEN(A.[Avg_Q_66_13]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_66_13], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_66_13]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_66_14]) = 0 AND LEN(A.[Avg_Q_66_14]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_66_14], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_66_14]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_66_15]) = 0 AND LEN(A.[Avg_Q_66_15]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_66_15], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_66_15]) NOT BETWEEN 0.000000 AND 1.000000))
			...
			OR ((ISNUMERIC(A.[Avg_Q_67_11]) = 0 AND LEN(A.[Avg_Q_67_11]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_67_11], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_67_11]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_67_12]) = 0 AND LEN(A.[Avg_Q_67_12]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_67_12], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_67_12]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_67_13]) = 0 AND LEN(A.[Avg_Q_67_13]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_67_13], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_67_13]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_67_14]) = 0 AND LEN(A.[Avg_Q_67_14]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_67_14], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_67_14]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_67_15]) = 0 AND LEN(A.[Avg_Q_67_15]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_67_15], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_67_15]) NOT BETWEEN 0.000000 AND 1.000000))
			...
			OR ((ISNUMERIC(A.[Avg_Q_68_11]) = 0 AND LEN(A.[Avg_Q_68_11]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_68_11], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_68_11]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_68_12]) = 0 AND LEN(A.[Avg_Q_68_12]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_68_12], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_68_12]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_68_13]) = 0 AND LEN(A.[Avg_Q_68_13]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_68_13], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_68_13]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_68_14]) = 0 AND LEN(A.[Avg_Q_68_14]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_68_14], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_68_14]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_68_15]) = 0 AND LEN(A.[Avg_Q_68_15]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_68_15], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_68_15]) NOT BETWEEN 0.000000 AND 1.000000))
			...
			OR ((ISNUMERIC(A.[Avg_Q_69_11]) = 0 AND LEN(A.[Avg_Q_69_11]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_69_11], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_69_11]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_69_12]) = 0 AND LEN(A.[Avg_Q_69_12]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_69_12], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_69_12]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_69_13]) = 0 AND LEN(A.[Avg_Q_69_13]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_69_13], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_69_13]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_69_14]) = 0 AND LEN(A.[Avg_Q_69_14]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_69_14], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_69_14]) NOT BETWEEN 0.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Avg_Q_69_15]) = 0 AND LEN(A.[Avg_Q_69_15]) > 0) OR (ISNUMERIC(COALESCE(A.[Avg_Q_69_15], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Avg_Q_69_15]) NOT BETWEEN 0.000000 AND 1.000000))
			...
			*/
			OR ((ISNUMERIC(A.[NPS_MEM]) = 0 AND LEN(A.[NPS_MEM]) > 0) OR (ISNUMERIC(COALESCE(A.[NPS_MEM], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[NPS_MEM]) NOT BETWEEN -1.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[NPS_WORK]) = 0 AND LEN(A.[NPS_WORK]) > 0) OR (ISNUMERIC(COALESCE(A.[NPS_WORK], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[NPS_WORK]) NOT BETWEEN -1.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[RPI_COM]) = 0 AND LEN(A.[RPI_COM]) > 0) OR (ISNUMERIC(COALESCE(A.[RPI_COM], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[RPI_COM]) NOT BETWEEN -1.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[RPI_IND]) = 0 AND LEN(A.[RPI_IND]) > 0) OR (ISNUMERIC(COALESCE(A.[RPI_IND], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[RPI_IND]) NOT BETWEEN -1.000000 AND 1.000000))
			OR ((ISNUMERIC(A.[Achievement Z-Score]) = 0 AND LEN(A.[Achievement Z-Score]) > 0) OR (ISNUMERIC(COALESCE(A.[Achievement Z-Score], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Achievement z-score]) NOT BETWEEN -10.000000 AND 10.000000))
			OR ((ISNUMERIC(A.[Belonging Z-Score]) = 0 AND LEN(A.[Belonging Z-Score]) > 0) OR (ISNUMERIC(COALESCE(A.[Belonging Z-Score], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Belonging z-score]) NOT BETWEEN -10.000000 AND 10.000000))
			OR ((ISNUMERIC(A.[Character Z-Score]) = 0 AND LEN(A.[Character Z-Score]) > 0) OR (ISNUMERIC(COALESCE(A.[Character Z-Score], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Character z-score]) NOT BETWEEN -10.000000 AND 10.000000))
			OR ((ISNUMERIC(A.[Giving Z-Score]) = 0 AND LEN(A.[Giving Z-Score]) > 0) OR (ISNUMERIC(COALESCE(A.[Giving Z-Score], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Giving z-score]) NOT BETWEEN -10.000000 AND 10.000000))
			OR ((ISNUMERIC(A.[Health Z-Score]) = 0 AND LEN(A.[Health Z-Score]) > 0) OR (ISNUMERIC(COALESCE(A.[Health Z-Score], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Health z-score]) NOT BETWEEN -10.000000 AND 10.000000))
			OR ((ISNUMERIC(A.[Inspiration Z-Score]) = 0 AND LEN(A.[Inspiration Z-Score]) > 0) OR (ISNUMERIC(COALESCE(A.[Inspiration Z-Score], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Inspiration z-score]) NOT BETWEEN -10.000000 AND 10.000000))
			OR ((ISNUMERIC(A.[Meaning Z-Score]) = 0 AND LEN(A.[Meaning Z-Score]) > 0) OR (ISNUMERIC(COALESCE(A.[Meaning Z-Score], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Meaning z-score]) NOT BETWEEN -10.000000 AND 10.000000))
			OR ((ISNUMERIC(A.[Relationship Z-Score]) = 0 AND LEN(A.[Relationship Z-Score]) > 0) OR (ISNUMERIC(COALESCE(A.[Relationship Z-Score], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Relationship z-score]) NOT BETWEEN -10.000000 AND 10.000000))
			OR ((ISNUMERIC(A.[Safety Z-Score]) = 0 AND LEN(A.[Safety Z-Score]) > 0) OR (ISNUMERIC(COALESCE(A.[Safety Z-Score], '')) = 1 AND CONVERT(DECIMAL(20, 6), A.[Safety z-score]) NOT BETWEEN -10.000000 AND 10.000000))
